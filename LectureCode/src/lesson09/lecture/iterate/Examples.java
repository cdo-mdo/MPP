package lesson09.lecture.iterate;
...
//        stream0.limit(5).collect(Collectors.toList()).forEach(System.out::print);
        stream0.limit(10).collect(Collectors.toList()).forEach(System.out::print);
        System.out.println("\n");
        stream1.limit(5).collect(Collectors.toList()).forEach(System.out::print);
        System.out.println("\n");
        stream2.limit(50).collect(Collectors.toList()).forEach(System.out::println);
    }
