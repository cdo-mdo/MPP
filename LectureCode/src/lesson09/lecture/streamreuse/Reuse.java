package lesson09.lecture.streamreuse;
...
public class Reuse {
    private static final BiFunction<List<String>, String, Stream<String>> listStartsWith = (list, letter) -> list
    ...
    public List<String> listEditorsNamesStartingWithNUpperCase() {
        return listStartsWith.apply(Folks.editors, "N").map(name -> name.toUpperCase()).collect(Collectors.toList());
    }
